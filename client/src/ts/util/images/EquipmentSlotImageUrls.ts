...
const arrowSlotSrc       = getImageSrcManual("ui/equipment-menu/arrow", "256")
const boltSlotSrc        = getImageSrcManual("ui/equipment-menu/bolt",  "256")
...
export type EquipmentSlotBackgroundId = keyof IEquipmentSlotImageUrls
