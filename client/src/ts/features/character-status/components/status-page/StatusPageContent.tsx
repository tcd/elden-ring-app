    ...
    return (
        <Grid container direction="row" columns={3} columnSpacing={20} sx={{ maxWidth: "100vw" }}>
            ...
            <Grid xs={3} sm={1}>
                ...
                <ErCard2 title="Attribute Points" smallTitle={true} icon="AttributePoints">
                    <ul>
                        {attributeRows}
                    </ul>
                </ErCard2>
                <ErCard2 title="Lineage" smallTitle={true} icon="Lineage">
                    <ul>
            ...
            <Grid xs={3} sm={1}>
                <ErCard2 title="Base Stats" smallTitle={true} icon="BaseStats" sx={{ height: { xs: "unset", sm: "unset", md: "100%", lg: "100%", xl: "100%" } }}>
            ...
            <Grid xs={3} sm={1} columns={1}>
                <ErCard2 title="Attack Power" smallTitle={true} icon="AttackPower">
                    <Attack />
                </ErCard2>
                <ErCard2 title="Defense/Dmg Negation" smallTitle={true} icon="DefenseDmgNegation">
                    <DefensePlus />
                </ErCard2>
                <ErCard2 title="Resistance" smallTitle={true} icon="Resistance">
                    <Resistance />
                </ErCard2>
            </Grid>
