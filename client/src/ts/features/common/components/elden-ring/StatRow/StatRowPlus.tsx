        ...
        return (
            <MouseOverPopover id={id} popoverContent={props.description}>
                <li className="er__stat-row-plus">
                    ...
                    <span className={`er__stat-row__column er__stat-row__column--color-${props.value_1_color}`}>{props.value_1}</span>
                    <span className={`er__stat-row__column er__stat-row__column--color-${props.divider_color}`}>{props.divider}</span>
                    <span className={`er__stat-row__column er__stat-row__column--color-${props.value_2_color}`}>{props.value_2}</span>
                </li>
            </MouseOverPopover>
        )
    }
